...
class MemberResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "[@-K`u.a1e";
    private static final String UPDATED_EMAIL = "nN@l.Nn5Ji";
    ...
    public static Member createEntity() {
        return new Member().login(DEFAULT_LOGIN).firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).email(DEFAULT_EMAIL);
    }
    ...
    public static Member createUpdatedEntity() {
        return new Member().login(UPDATED_LOGIN).firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL);
    }
    ...
    void putExistingMember() throws Exception {
        ...
        updatedMember.login(UPDATED_LOGIN).firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL);
    ...
    void fullUpdateMemberWithPatch() throws Exception {
        ...
        partialUpdatedMember.login(UPDATED_LOGIN).firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).email(UPDATED_EMAIL);
